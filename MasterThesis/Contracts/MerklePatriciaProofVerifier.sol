...
library MerklePatriciaProofVerifier {
    ...
    function extractProofValue(
        ...
        if (stack.length == 0) {
            ...
            require(rootHash == 0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421,"Root hash of empty Merkle-Patricia-Trie");
            return new bytes(0);
        }
        ...
        for (uint256 i = 0; i < stack.length; i++) {
            ...
            if (i == 0 && rootHash != stack[i].rlpBytesKeccak256()) {
                require(rootHash == stack[i].rlpBytesKeccak256(),"il root node non coincide"); //riga aggiunta da me
                revert();
            }
            // ... whereas all other nodes are hashed with the MPT
            // hash function.
            if (i != 0 && nodeHashHash != _mptHashHash(stack[i])) {
                require(nodeHashHash == _mptHashHash(stack[i]), "è un'altro nodo a non coincidere");//riga aggiunta da me
                revert();
            }
